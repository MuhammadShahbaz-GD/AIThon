...
namespace KickTheBuddy.Haptics
{
    ...
    public sealed class GameplayHapticsAdapter : MonoBehaviour
    {
        ...
        private GameplayManager gameplay; private GameSaveManager saves; private RagdollController ragdoll;
        private void Start()
        {
            ...
            gameplay = root.Gameplay; saves = root.Saves; haptics.Configure(saves.Data.vibrationEnabled);
            gameplay.LevelCompleted += HandleComplete; gameplay.LevelFailed += HandleFailed; BindRagdoll();
        }
        ...
        private void BindRagdoll() { ragdoll = FindObjectOfType<RagdollController>(); if (ragdoll == null) return; ragdoll.OnDamageTaken += HandleDamage; ragdoll.OnLimbBroken += HandleLimbBreak; }
        ...
        private void OnDestroy() { if (gameplay != null) { gameplay.LevelCompleted -= HandleComplete; gameplay.LevelFailed -= HandleFailed; } if (ragdoll != null) { ragdoll.OnDamageTaken -= HandleDamage; ragdoll.OnLimbBroken -= HandleLimbBreak; } }
    }
}
